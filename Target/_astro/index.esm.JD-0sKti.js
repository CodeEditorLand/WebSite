 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Pe(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Pe(t){const e=t.getComponent();return e?.type==="VERSION"}const O="@firebase/app",V="0.10.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function It(t){$(new D("platform-logger",e=>new He(e),"PRIVATE")),$(new D("heartbeat",e=>new Et(e),"PRIVATE")),y(O,V,t),y(O,V,"esm2017"),y("fire-js","")}It("");var vt="firebase",wt="10.12.5";/**
 * @license
...
//# sourceMappingURL=index.esm.JD-0sKti.js.map
